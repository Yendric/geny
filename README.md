...
This also makes CI trivial: the geny version is pinned in your lockfile, and any host that runs `npm install` + `npm run build` (Cloudflare Pages, Netlify, GitHub Actions, ...) just works with no custom install script.
